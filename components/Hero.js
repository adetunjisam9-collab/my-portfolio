  ...
  return (
    <section className="min-h-screen flex items-center justify-center px-6 pt-20">
      <div className="max-w-5xl mx-auto text-center">
        ...
        <h1 data-aos="fade-up" data-aos-delay="100" className="text-5xl md:text-7xl font-bold text-gray-900 mb-6 leading-tight">
          I build full-stack
          <br />
          <span className="text-blue-600">web applications</span>
        </h1>
        <p data-aos="fade-up" data-aos-delay="200" className="text-xl text-gray-500 max-w-2xl mx-auto mb-10 leading-relaxed">
        ...
        <div data-aos="fade-up" data-aos-delay="400" className="mt-16 flex items-center justify-center gap-10 text-center">
          <div>
