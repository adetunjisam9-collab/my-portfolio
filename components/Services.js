    ...
    <section id="services" className="py-16 px-6 bg-gray-50">
      <div className="max-w-5xl mx-auto">
        <div data-aos="fade-up">
          ...
          <p className="text-blue-600 font-medium text-sm uppercase tracking-wide mb-2">What I offer</p>
          <h2 className="text-3xl font-bold text-gray-900 mb-3">Services</h2>
          <p className="text-gray-500 mb-10 max-w-xl text-sm">Everything you need to take your idea from concept to a live, production-ready product.</p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {services.map((service, i) => (
            <div key={i} data-aos="fade-up" data-aos-delay={i * 100} className="bg-white rounded-2xl border border-gray-200 p-5 hover:border-blue-300 hover:shadow-md transition duration-300">
        ...
        <div data-aos="fade-up" className="mt-10 text-center">
          <p className="text-gray-500 text-sm mb-4">Have something specific in mind?</p>
